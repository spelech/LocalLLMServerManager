...
def main():
    parser = argparse.ArgumentParser(
        description="Download Juggernaut XL v9 checkpoint from Hugging Face Hub."
    )
    parser.add_argument(
        "-c", "--checkpoints-dir",
    ...
    dest_file = os.path.join(checkpoints_dir, "Juggernaut-XL_v9_RunDiffusionPhoto_v2.safetensors")
    ...
    try:
        ...
        print(f"Failed to download Juggernaut XL v9: {e}", file=sys.stderr)
