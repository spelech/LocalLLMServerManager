...
- [x] **Task 1: Domain Models & Mathematical Sizing Engine**
...
- [x] **Task 2: Hardware REST API Endpoints**
...
- [x] **Task 3: CanIRunItViewModel & Reactive Calculations**
...
- [x] **Task 4: CanIRunItView.axaml Avalonia UI & Main Navigation Integration**
...
- [x] **Task 5: Ambient Compatibility Badges on Search & Library Cards**
...
- [x] **Task 6: Verification Suite, WASM Bundle Publish, Playwright E2E & PR**
