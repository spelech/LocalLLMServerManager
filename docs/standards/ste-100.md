# ASD-STE100 Documentation Standards

This document defines the Simplified Technical English (ASD-STE100) rules for the Local LLM Server Manager documentation. All contributors and automated agents must follow these rules.

Simplified Technical English improves clarity, eliminates ambiguity, and aids machine translation.
