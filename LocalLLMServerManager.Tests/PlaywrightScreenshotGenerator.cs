...
public class PlaywrightScreenshotGenerator : IClassFixture<AppTestServerFixture>
{
    ...
    public async Task GenerateRealDocScreenshots()
    {
        ...
        await page.Mouse.ClickAsync(100, 115);
        ...
        await page.Mouse.ClickAsync(250, 115);
        await page.WaitForTimeoutAsync(1000);
        ...
        await page.Mouse.ClickAsync(420, 115);
        await page.WaitForTimeoutAsync(1000);
        ...
        await page.Mouse.ClickAsync(600, 115);
        await page.WaitForTimeoutAsync(1000);
        ...
        await page.Mouse.ClickAsync(780, 115);
        await page.WaitForTimeoutAsync(1000);
